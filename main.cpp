...
int main(){
    ...
    /*std::cout << "Le Livre " << premierEmprunt.getIsbn().getIsbn() << " a été emprunté le : " << emprunt << " et il a été emprunté par : " << premierEmprunt.getIdentifiant() << std::endl;
